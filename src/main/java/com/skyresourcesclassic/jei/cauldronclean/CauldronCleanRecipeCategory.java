package com.skyresourcesclassic.jei.cauldronclean;
...
public class CauldronCleanRecipeCategory implements IRecipeCategory {
    ...
    private final String localizedName = I18n.translateToLocalFormatted("jei.skyresourcesclassic.recipe.cauldronclean");
